<div class="modal fade" id="release_surat_modal" role="dialog" aria-labelledby="release_surat_modal" >
    <div class="modal-dialog modal-xl" style="width: 100%" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="release_surat_modal_label">View Form</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form id="surat_release" class="section-to-print" action="{{ route('release_surat')}}" method="post">
                ...
                <div class="col col-lg-12" style="margin-bottom: 20xp">
                    ...
                    <button class="btn btn-success float-right" type="submit" id="submit_released">Submit</button>
                </div>
            ...
            <div class="col-lg-4">
                <form id="form-print" action="{{ route('print_page')}}" target="_blank" method="post">
                    ...
                    <a class="btn btn-danger mr-2" style="width: 48%;"> PDF </a>
                    <a class="btn btn-info" id="btn-print" style="width: 48%;" onclick="print_page()" > Print </a>
                </form>      
            </div>
